...
export async function generateMetadata({
  ...
  const title       = meta?.title       ?? 'Build Your Wedding Package | Punta Cana Wedding Packages'
  const description = meta?.description ?? 'Design your dream destination wedding step by step. See real prices for every choice — menu, decor, photography, and more.'
