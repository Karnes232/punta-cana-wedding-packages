        ...
        defineField({
          ...
          fields: [
            defineField({
              ...
              description: 'Browser tab + search results (50–60 chars recommended)',
              validation: (Rule) =>
        ...
        defineField({
          ...
          fields: [
            defineField({
              ...
              description: 'Pestaña del navegador + resultados de búsqueda (50–60 caracteres recomendados)',
              validation: (Rule) =>
                Rule.max(60).warning('Los títulos de más de 60 caracteres pueden aparecer truncados'),
            }),
            defineField({
              name: 'description',
              title: 'Meta Description',
              ...
              description: 'Fragmento en resultados de búsqueda (150–160 caracteres recomendados)',
              validation: (Rule) =>
                Rule.max(160).warning('Las descripciones de más de 160 caracteres pueden aparecer truncadas'),
            }),
            defineField({
              name: 'keywords',
              title: 'Keywords',
        ...
        defineField({
          ...
          fields: [
            defineField({
              ...
              type: 'string',
              initialValue: 'Punta Cana Wedding Packages',
              description: 'Title shown when shared on social media (falls back to Meta Title if blank)',
            }),
            defineField({
              name: 'description',
              ...
              initialValue:
                'Design your dream destination wedding in Punta Cana, Dominican Republic. Transparent pricing, real choices, zero stress.',
              description: 'Description shown when shared on social media (falls back to Meta Description if blank)',
            }),
          ],
        }),
        ...
        defineField({
          ...
          fields: [
            defineField({
              ...
              type: 'string',
              initialValue: 'Paquetes de Bodas en Punta Cana',
              description: 'Título al compartir en redes sociales (usa el Meta Title si está en blanco)',
            }),
            defineField({
              name: 'description',
              title: 'OG Description',
