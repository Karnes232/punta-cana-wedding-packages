...
export const homePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'image',
      group: 'hero',
      description: 'Beach wedding photo shown beside the headline. Landscape orientation recommended.',
    ...
    defineField({
      ...
      type: 'array',
      group: 'customize',
      description: 'Photo mosaic showing customizable elements (5 images recommended).',
      of: [
        defineArrayMember({
          type: 'image',
          options: { hotspot: true },
    ...
    defineField({
      ...
      type: 'number',
      group: 'pricing',
      description: 'The lowest package starting price shown on the home page. Example: 4100',
    ...
    defineField({
      ...
      type: 'localizedText',
      group: 'pricing',
      description: 'Short paragraph below the starting price explaining the pricing approach.',
    }),
