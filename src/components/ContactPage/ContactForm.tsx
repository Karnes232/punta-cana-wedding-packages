...
export default function ContactForm({ phone, email, introText }: Props) {
    ...
    try {
      await fetch("/", {
        ...
        body: new URLSearchParams(
          Object.fromEntries(new FormData(formRef.current)) as Record<
            string,
            string
          >,
        ).toString(),
  ...
  const labelClass =
    "mb-2 block text-xs font-semibold uppercase tracking-wide text-[#666666]";
              ...
              <div className="mt-8 space-y-5">
                ...
                {email && (
                  ...
                  >
                    {/* Email icon */}
                    <svg
                      className="h-5 w-5 shrink-0 text-[#5B9FD9]"
                      viewBox="0 0 24 24"
                      fill="none"
                      aria-hidden="true"
                    >
                ...
                <div className="flex items-start gap-3 rounded-xl border border-[#E8F0F7] bg-[#F6FAFE] px-5 py-4">
                  {/* Pin icon */}
                  <svg
                    className="mt-0.5 h-5 w-5 shrink-0 text-[#5B9FD9]"
                    viewBox="0 0 24 24"
                    fill="none"
                    aria-hidden="true"
                  >
