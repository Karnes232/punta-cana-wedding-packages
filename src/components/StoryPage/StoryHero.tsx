    ...
    <section className="relative h-[60vh] min-h-[400px] w-full overflow-hidden bg-[#F5F1E8]">
      ...
      <div className="absolute bottom-0 left-0 right-0 px-6 pb-10 text-white">
        <div className="mx-auto max-w-4xl">
          <h1 className="text-3xl font-semibold drop-shadow-sm md:text-5xl">{coupleName}</h1>
          {formattedDate && (
            <p className="mt-2 text-sm font-medium text-white/80 md:text-base">{formattedDate}</p>
          )}
        </div>
      </div>
    </section>
