...
const FALLBACK_STEPS = [
  {
    ...
    description: 'Pick your date, guest count, and venue preference in seconds.',
  },
  {
    title: 'Customize Everything',
    description: 'Select your menu, decor, photography, entertainment, and more.',
  },
  {
    title: 'See Your Price',
    description: 'Every choice updates your estimated total in real time — no surprises.',
  },
  {
