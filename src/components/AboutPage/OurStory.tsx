          ...
          <div>
            ...
            <div className="prose prose-base mt-6 max-w-none text-[#444444] [&_p]:leading-relaxed [&_p]:text-[#444444] [&_strong]:text-[#1A1A1A]">
              {hasContent ? (
                ...
                <>
                  <p>
                    We started Punta Cana Wedding Packages with a simple belief: planning a
                    destination wedding should feel exciting — not overwhelming. Too many couples
                    spent months chasing quotes, coordinating vendors, and managing uncertainty.
                    We built a better way.
                  </p>
                  <p>
                    Based at the stunning Cabeza de Toro beach, our team brings years of experience
                    in destination weddings together with a transparent, technology-driven planning
                    process. Every couple deserves to see exactly what their wedding costs before
